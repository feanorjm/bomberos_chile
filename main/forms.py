...
class BitacoraForm(forms.ModelForm):
    class Meta:
        model = Bitacora
        fields = ['company', 'maquina', 'conductor', 'direccion', 'fecha',
...
class MantencionForm(forms.ModelForm):
    class Meta:
        model = Mantencion
        fields = ['fecha', 'company', 'maquina', 'ki_salida', 'ki_regreso', 'ho_salida', 'ho_regreso', 'cod_man',
...
class DetalleMantencionForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['mantencion', 'division', 'subdivision', 'tipo_mantencion', 'servicio', 'des_detalle',
                  'hodometro_prox_man', ]
        widgets = {
...
class MaquinaForm(forms.ModelForm):
    # conductor = forms.ModelMultipleChoiceField(widget=forms.CheckboxSelectMultiple,queryset=Conductor.objects.filter(company__id = 1))
    class Meta:
        model = Maquina
        fields = {'nombre',
                  'clasificacion',
        ...
        widgets = {
            ...
            'costo_seg_auto': forms.TextInput(
                attrs={'class': 'form-control', 'pattern': '[0-9]*', 'placeholder': 'ej:30000'}),
...
class ConductorForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['company', 'rut', 'nombre', 'ap_paterno', 'ap_materno', 'num_licencia', 'venc_lic', 'foto',
                  'observaciones_cond']
        widgets = {
            'company': forms.Select(attrs={'class': 'form-control'}),
...
class CombustibleForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['company', 'maquina', 'litros', 'servicentro', 'km_salida', 'km_regreso', 'hm_salida', 'hm_regreso',
