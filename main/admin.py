...
class UsuarioCompAdmin(admin.ModelAdmin):
    list_display = ('user', 'tipo', 'company')
...
class ConductorAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'ap_materno', 'ap_materno', 'company')
    list_filter = ['company', ]


class MaquinaAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'clasificacion', 'company', 'tiene_bomba')
    list_filter = ['clasificacion', 'company', 'tiene_bomba']
...
class CargaCombustibleAdmin(admin.ModelAdmin):
    list_display = ('id', 'company', 'servicio_id', 'maquina', 'litros', 'servicentro', 'valor')
    list_filter = ['company', 'maquina', ]
...
class BitacoraAdmin(admin.ModelAdmin):
    list_display = ('id', 'company', 'maquina', 'conductor', 'clave', 'fecha', 'observciones')
    list_filter = ['company', 'maquina']
